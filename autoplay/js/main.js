!function(){
  let innerStyle = document.querySelector('#innerStyle')
  let preCode = document.querySelector('#code')
  function writeCode(content){
    let id, n = 0
    id = setTimeout(function run(){
      n += 1
      preCode.innerHTML += content.slice(n-1,n)
      preCode.innerHTML = Prism.highlight(preCode.textContent, Prism.languages.css);
